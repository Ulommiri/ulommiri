...
export const galleryImages: GalleryImage[] = [
	...
	{ src: livingRoomFireplaceHd, alt: "The living room fireplace and walnut wall" },
	{ src: kitchen, alt: "The chef's kitchen in white stone" },
	{ src: diningLakeview, alt: "The dining table looking out to the water" },
	{ src: terraceLakeviewHd, alt: "The covered terrace above the lake" },
	...
	{ src: houseFrontDay, alt: "The front of the house in daylight" },
	{ src: houseRearDay, alt: "The rear of the house and the pool in daylight" },
	{ src: lakeAerialWide, alt: "The house on the lake from above" },
	{ src: kitchenLakeview, alt: "The kitchen looking through to the lake" },
	{ src: gamesLoft, alt: "The billiards loft with a wet bar and lake views" },
	{ src: mediaLounge, alt: "The media lounge with floor seating and a garden door" },
	{ src: study, alt: "The study with a sculpted desk and lit alcoves" },
	{ src: bedroomSuite, alt: "A bedroom suite in linen and warm oak" },
	{ src: primaryBath, alt: "The primary bathroom with freestanding tub and walk-in shower" },
	{ src: guestBathWhite, alt: "A guest bathroom in white subway tile" },
	{ src: guestBathBlack, alt: "A guest bathroom in black tile" },
	{ src: guestBathSubway, alt: "A guest bathroom with vessel basin and walk-in shower" },
];
...
export const houseInteriors: HouseInterior[] = [
	...
	{
		src: kitchenLakeview,
		alt: "The kitchen looking through to the lake",
		caption: "The kitchen, toward the water",
	},
	{
		src: diningLakeview,
	...
	{
		src: bedroomSuite,
		alt: "A bedroom suite in linen and warm oak",
		caption: "A bedroom suite",
	},
	{
		src: primaryBath,
		alt: "The primary bathroom with freestanding tub and walk-in shower",
		caption: "The primary bath",
	},
	{
		src: guestBathWhite,
		alt: "A guest bathroom in white subway tile",
		caption: "A guest bath",
	},
	{
		src: guestBathBlack,
		alt: "A guest bathroom in black tile",
		caption: "A guest bath",
	},
	{
		src: guestBathSubway,
		alt: "A guest bathroom with vessel basin and walk-in shower",
		caption: "A guest bath",
	},
	{
		src: gamesLoft,
		alt: "The billiards loft with a wet bar and lake views",
		caption: "The games loft",
	},
	{
		src: mediaLounge,
		alt: "The media lounge with floor seating and a garden door",
		caption: "The media lounge",
	},
	{
		src: study,
		alt: "The study with a sculpted desk and lit alcoves",
		caption: "The study",
	},
	{
		src: nursery,
	...
	{
		src: houseRearDay,
		alt: "The rear of the house and the pool in daylight",
		caption: "The rear elevation",
	},
	{
		src: houseFrontDay,
		alt: "The front of the house in daylight",
	...
	{
		src: lakeAerialWide,
		alt: "The house on the lake from above",
		caption: "The lake",
	},
	{
		src: houseAerialLake,
